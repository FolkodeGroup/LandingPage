  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full relative">
        ...
        {/* Glassmorphism Card para textos */}
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1 }}
          className="absolute top-1/2 left-0 -translate-y-1/2 text-left px-6 sm:px-10 md:px-16 max-w-none z-[2]"
        >
          <div
            className="backdrop-blur-xl bg-white/5 border border-white/30 rounded-2xl shadow-2xl p-8 md:p-12"
            style={{
              ...
              minWidth: '340px',
              background:
                'linear-gradient(135deg, rgba(1,69,79,0.60) 0%, rgba(2,81,89,0.60) 60%, rgba(134,168,105,0.35) 100%)',
            }}
          >
            <motion.h1
